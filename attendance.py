...
def main():
    ...
    # 四楼:1911300460207
    # 三楼:1911300460094
	# 2016-10-01开始使用指纹打卡，设备号：6050161900389

    try:
        ms = MSSQL(host="192.168.2.228", user="sa", pwd="admin520520", db="zktime8")
        ...
        insertRec1 = ms.ExecNonQuery(
            "INSERT INTO zktime8.dbo.CHECKINOUT(CHECKTIME,CHECKTYPE,VERIFYCODE,SN_NAME,PIN) VALUES(DATEADD(second,ABS(CHECKSUM(NEWID())) % DATEDIFF(second,'08:00','08:25'),CONVERT(char(8),getdate(),112) + ' 08:00'),255,1,6050161900389,'0006320835');")
        insertRec2 = ms.ExecNonQuery(
            "INSERT INTO zktime8.dbo.CHECKINOUT(CHECKTIME,CHECKTYPE,VERIFYCODE,SN_NAME,PIN) VALUES(DATEADD(second,ABS(CHECKSUM(NEWID())) % DATEDIFF(second,'12:00','12:10'),CONVERT(char(8),getdate(),112) + ' 12:00'),255,1,6050161900389,'0006320835');")
        insertRec3 = ms.ExecNonQuery(
            "INSERT INTO zktime8.dbo.CHECKINOUT(CHECKTIME,CHECKTYPE,VERIFYCODE,SN_NAME,PIN) VALUES(DATEADD(second,ABS(CHECKSUM(NEWID())) % DATEDIFF(second,'12:30','12:40'),CONVERT(char(8),getdate(),112) + ' 12:30'),255,1,6050161900389,'0006320835');")
        insertRec4 = ms.ExecNonQuery(
            "INSERT INTO zktime8.dbo.CHECKINOUT(CHECKTIME,CHECKTYPE,VERIFYCODE,SN_NAME,PIN) VALUES(DATEADD(second,ABS(CHECKSUM(NEWID())) % DATEDIFF(second,'17:30','18:00'),CONVERT(char(8),getdate(),112) + ' 17:30'),255,1,6050161900389,'0006320835');")
        query = ms.ExecQuery(
